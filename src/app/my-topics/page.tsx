...
import { MyTopicsTable } from '@/components/my-topics-table';
...
export default function MyTopicsPage() {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-8">
      <h1 className="text-2xl font-bold">Quản lý Đề tài của tôi</h1>
      <Suspense fallback={<Skeleton className="h-[400px] w-full rounded-lg" />}>
        <MyTopicsTable supervisorId={user.uid} supervisorName={userData.displayName || user.email || 'N/A'} />
      </Suspense>
    </div>
  );
}
