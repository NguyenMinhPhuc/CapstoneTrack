  ...
  return (
    <DialogContent className="sm:max-w-md">
      <DialogHeader>
        ...
        <DialogDescription>
          Hệ thống sẽ tự động chia đều các đề tài chưa được phân công vào các
          tiểu ban hiện có. Các sinh viên cùng đề tài sẽ được xếp vào cùng một
          tiểu ban.
        </DialogDescription>
      </DialogHeader>
      ...
      <div className="py-4 space-y-4">
        {subCommittees.length > 0 ? (
          ...
          <Alert>
            ...
            <AlertDescription>
              Bạn cần vào mục Quản lý Hội đồng để tạo các tiểu ban trước khi có
              thể phân công.
            </AlertDescription>
          </Alert>
        )}
