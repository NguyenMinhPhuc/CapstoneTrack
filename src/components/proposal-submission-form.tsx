...
const formSchema = z.object({
  ...
  objectives: z
    .string()
    .min(10, { message: "Mục tiêu cần có ít nhất 10 ký tự." }),
  implementationPlan: z
    .string()
    .min(10, { message: "Kế hoạch thực hiện cần có ít nhất 10 ký tự." }),
  expectedResults: z
    .string()
    .min(10, { message: "Kết quả mong đợi cần có ít nhất 10 ký tự." }),
  proposalLink: z
    .string()
...
export function ProposalSubmissionForm({
  ...
  const implementationPlanRef = React.useRef<HTMLTextAreaElement | null>(null);
    ...
    updateDoc(registrationDocRef, dataToUpdate)
      .then(() => {
        toast({
          ...
          description:
            "Thuyết minh của bạn đã được gửi để chờ giáo viên duyệt.",
        });
      })
      .catch((error) => {
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input
                  placeholder="Ví dụ: Xây dựng hệ thống quản lý đề tài tốt nghiệp..."
                  {...field}
            ...
            return (
              <FormItem>
                ...
                <FormControl>
                  <Textarea
                    ref={(el) => {
                      implementationPlanRef.current = el;
                      ref(el);
                    }}
