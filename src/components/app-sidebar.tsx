...
export function AppSidebar() {
  ...
  const { data: supervisorData, isLoading: isLoadingSupervisorData } =
  ...
  const isPostDefenseSubmissionEnabled =
    settings?.enablePostDefenseSubmission ?? false;
            ...
            <>
              ...
              <Collapsible asChild defaultOpen>
                <SidebarGroup>
                  ...
                  <CollapsibleContent asChild>
                    <SidebarMenu>
                      {(supervisorData?.canGuideGraduation ||
                        userData?.role === "admin") && (
                        <>
                          <SidebarMenuItem>
                            <SidebarMenuButton
                      ...
                      {(supervisorData?.canGuideInternship ||
                        userData?.role === "admin") && (
                        <>
                          <SidebarMenuItem>
                            <SidebarMenuButton
